    ...
    <div class="section-container">
      <div class="text-center mb-16">
        <h2 class="heading-xl text-gray-900 mb-4">
          Get In <span class="text-accent-600">Touch</span>
        </h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <div class="space-y-8 mb-8">
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <p class="text-gray-600">123 Fitness Street, Downtown</p>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <a href="mailto:coach@fitlife.com" class="text-accent-600 hover:text-accent-700">
                  coach@fitlife.com
                </a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                ...
                <a href="tel:+15551234567" class="text-accent-600 hover:text-accent-700">
                  (555) 123-4567
                </a>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div class="ml-4">
                <h3 class="text-lg font-bold text-gray-900 mb-1">Hours</h3>
                <p class="text-gray-600">Monday - Friday: 6:00 AM - 8:00 PM</p>
                <p class="text-gray-600">Saturday: 8:00 AM - 6:00 PM</p>
          ...
          <div class="flex space-x-4">
            <a
              href="#"
              class="w-12 h-12 bg-gray-100 hover:bg-accent-600 rounded-lg flex items-center justify-center transition group"
              aria-label="Facebook"
            >
              <svg class="w-6 h-6 text-gray-600 group-hover:text-white transition" fill="currentColor" viewBox="0 0 24 24">
